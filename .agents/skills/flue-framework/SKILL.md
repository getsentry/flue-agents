...
2. In this repo, preserve the `src/` layout: `src/agents/`, `src/workflows/`, `src/skills/`, `src/app.ts`, and `src/cloudflare.ts`. Do not add `.flue/` or root-level Flue modules unless the whole repo is being migrated.
